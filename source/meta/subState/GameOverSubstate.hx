	...
	public function new(x:Float, y:Float)
	{
		...
		switch (daBoyfriendType)
		{
			...
			case 'bf-pixel':
				daBf = 'bf-pixel-dead';
				stageSuffix = '-pixel';
			case 'blake': //later add explosion effect for blake
				altBf = "blake";
				daBf = 'bf-pixel-dead';
				stageSuffix = '-pixel';
			default:
		...
		/*
		if (altBf == "blake") {
			var vineBoom = new ExplosionFx(bf.getGraphicMidpoint().x - 90, bf.getGraphicMidpoint().y - 160);
			add(vineBoom);
