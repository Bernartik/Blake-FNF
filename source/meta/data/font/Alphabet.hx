	...
	override function update(elapsed:Float)
	{
		...
		if (isMenuItem)
		{
			if (ownerText == null) {
				...
				//var ownerScaledY = FlxMath.remapToRange(ownerText.targetY, 0, 1, 0, 1.3);
				//y = FlxMath.lerp(y, (ownerScaledY * 120) + 30 , elapsed * 6);
				//x = FlxMath.lerp(x, (ownerScaledY * 120) + 35, elapsed * 6);
				y = FlxMath.lerp(y, ownerText.y + 75, elapsed * 64);
				x = FlxMath.lerp(x, ownerText.x + 60, elapsed * 64);
			}
		}
