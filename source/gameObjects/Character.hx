	...
	public function setCharacter(x:Float, y:Float, character:String)
	{
		...
		switch (curCharacter)
		{
			...
			case 'blake':
				...
				animation.addByPrefix('idle', 'bfblake idle', 24, false);
				if (isPlayer) //left and right animations swap for player
				{
					animation.addByPrefix('singLEFT', 'bfblake singRIGHT0', 24, false);
					animation.addByPrefix('singRIGHT', 'bfblake singLEFT0', 24, false);
					animation.addByPrefix('singLEFTmiss', 'bfblake singRIGHTmiss', 24, false);
					animation.addByPrefix('singRIGHTmiss', 'bfblake singLEFTmiss', 24, false);
				}else {
					animation.addByPrefix('singLEFT', 'bfblake singLEFT0', 24, false);
					animation.addByPrefix('singRIGHT', 'bfblake singRIGHT0', 24, false);
					animation.addByPrefix('singLEFTmiss', 'bfblake singLEFTmiss', 24, false);
					animation.addByPrefix('singRIGHTmiss', 'bfblake singRIGHTmiss', 24, false);
				}
				animation.addByPrefix('singUP', 'bfblake singUP0', 24, false);
				animation.addByPrefix('singDOWN', 'bfblake singDOWN0', 24, false);
				animation.addByPrefix('singUPmiss', 'bfblake singUPmiss', 24, false);
				animation.addByPrefix('singDOWNmiss', 'bfblake singDOWNmiss', 24, false);
				...
				antialiasing = false;
			case 'ztatic':
				frames = Paths.getSparrowAtlas('characters/ztatic');
				animation.addByPrefix('idle', 'Ztatic idle', 24, false);
				animation.addByPrefix('singUP', 'Ztatic up', 24, false);
				animation.addByPrefix('singDOWN', 'Ztatic down', 24, false);
				animation.addByPrefix('singLEFT', 'Ztatic left', 24, false);
				animation.addByPrefix('singRIGHT', 'Ztatic right', 24, false);
