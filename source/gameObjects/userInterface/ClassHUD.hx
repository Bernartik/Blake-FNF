...
class ClassHUD extends FlxTypedGroup<FlxBasic>
{
	...
	public function new()
	{
		...
		//iconFC = new FcIcon();
		//iconFC.y = healthBar.y;
		//iconFC.x = healthBar.x + 750;
		//add(iconFC);
	...
	override public function update(elapsed:Float)
	{
		...
		//iconFC.setGraphicSize(Std.int(FlxMath.lerp(iconFC.initialWidth, iconFC.width, iconLerp)));
		...
		//iconFC.curframeidk += 0.15;
		//if (iconFC.curframeidk >= 9) {
		//	iconFC.curframeidk = 0;
		//}
		//iconFC.animation.curAnim.curFrame = Std.int(iconFC.curframeidk); //bootleg animation because animation.play doesn't fucking work
	}
	...
	public function beatHit()
	{
		if (!Init.trueSettings.get('Reduced Movements'))
		{
			...
			//iconFC.setGraphicSize(Std.int(iconP1.width + 45));
